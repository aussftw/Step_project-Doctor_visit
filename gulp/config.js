 ...
 * @type {String}
 */
const scriptsExtension = JSON.parse(fs.readFileSync('frontend.json', 'utf8')).scriptsLanguage;
...
const tasks = {
  js   : 'webpack',
  html : bundle.production ? 'pug-compile' : 'html-watch',
  pug : bundle.production ? 'pug-compile' : 'pug-watch',
...
module.exports = {
  ...
  tasksArray: [tasks.svg, tasks.js, tasks.css, tasks.html, tasks.pug]
};