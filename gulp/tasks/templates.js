 ...
 */
gulp.task('pug-compile', () => compileHtml('src/template/pages/*.pug', './dist/'));
...
gulp.task('html-watch', () => {
  gulp.watch('src/template/**/*.html', ['pug-compile']);
});
...
if (config.development) compileHtml('src/template/pages/*.pug', './dist/');